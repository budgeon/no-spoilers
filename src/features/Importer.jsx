      ...
      <div style={{background:G.surface, borderRadius:20, width:"100%", maxWidth:440, padding:"28px 24px", animation:"popIn 0.25s ease"}} onClick={e => e.stopPropagation()}>
        <div style={{display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:20}}>
          <div>
            ...
            <div style={{fontSize:12, color:G.muted, marginTop:2}}>Deadline: July 15, 2026</div>
          </div>
        ...
        {stage === "importing" && (
          <div style={{textAlign:"center", padding:"16px 0"}}>
            <div style={{fontSize:13, color:G.muted, marginBottom:12}}>Importing…</div>
